...
import { CreateCourse, editCourse, freeCourseEnrollment, getCourseById, getCourseByIdForCreator, getCreatorCourse, getMyCourses, getPublishedCourse, publishCourse, removeCourse, UnPublishCourse } from '../controller/courseController.js';
...
courseRouter.get("/myCourses", isAuth, getMyCourses);
